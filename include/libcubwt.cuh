...
#include <stdint.h>
    ...
    // int64_t libcubwt_sa_batch(thrust::device_vector<void *> device_storage, thrust::device_vector<thrust::device_vector<uint8_t>> T, thrust::device_vector<thrust::device_vector<uint32_t>> SA, 
    //     thrust::device_vector<uint32_t> n, int batchSize);
