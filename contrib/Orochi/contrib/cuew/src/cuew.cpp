...
// If this assert is wrong, it's advised either to install a CUDA SDK closed to version 12090 or search on the Orochi github a branch matching the CUDA SDK you are using.
// checking the major-version number only:
static_assert(  ((int)CUDA_VERSION / (int)1000) ==  ((int)12090/ (int)1000)  );
static_assert(  ((int)CUDART_VERSION / (int)1000) ==  ((int)12090/ (int)1000)  );
#endif
...
tcuCheckpointProcessCheckpoint *cuCheckpointProcessCheckpoint_oro = nullptr;
tcuCheckpointProcessGetRestoreThreadId *cuCheckpointProcessGetRestoreThreadId_oro = nullptr;
tcuCheckpointProcessGetState *cuCheckpointProcessGetState_oro = nullptr;
tcuCheckpointProcessLock *cuCheckpointProcessLock_oro = nullptr;
tcuCheckpointProcessRestore *cuCheckpointProcessRestore_oro = nullptr;
tcuCheckpointProcessUnlock *cuCheckpointProcessUnlock_oro = nullptr;
...
tcuCtxCreate_v4 *cuCtxCreate_v4_oro = nullptr;
...
tcuCtxFromGreenCtx *cuCtxFromGreenCtx_oro = nullptr;
...
tcuCtxGetDevResource *cuCtxGetDevResource_oro = nullptr;
...
tcuCtxRecordEvent *cuCtxRecordEvent_oro = nullptr;
...
tcuCtxWaitEvent *cuCtxWaitEvent_oro = nullptr;
...
tcuDevResourceGenerateDesc *cuDevResourceGenerateDesc_oro = nullptr;
tcuDevSmResourceSplitByCount *cuDevSmResourceSplitByCount_oro = nullptr;
...
tcuDeviceGetDevResource *cuDeviceGetDevResource_oro = nullptr;
...
tcuDeviceRegisterAsyncNotification *cuDeviceRegisterAsyncNotification_oro = nullptr;
...
tcuDeviceUnregisterAsyncNotification *cuDeviceUnregisterAsyncNotification_oro = nullptr;
...
tcuEventElapsedTime_v2 *cuEventElapsedTime_v2_oro = nullptr;
...
tcuFuncGetName *cuFuncGetName_oro = nullptr;
tcuFuncGetParamInfo *cuFuncGetParamInfo_oro = nullptr;
tcuFuncIsLoaded *cuFuncIsLoaded_oro = nullptr;
tcuFuncLoad *cuFuncLoad_oro = nullptr;
...
tcuGraphAddDependencies_v2 *cuGraphAddDependencies_v2_oro = nullptr;
...
tcuGraphAddNode_v2 *cuGraphAddNode_v2_oro = nullptr;
...
tcuGraphConditionalHandleCreate *cuGraphConditionalHandleCreate_oro = nullptr;
...
tcuGraphGetEdges_v2 *cuGraphGetEdges_v2_oro = nullptr;
...
tcuGraphNodeGetDependencies_v2 *cuGraphNodeGetDependencies_v2_oro = nullptr;
tcuGraphNodeGetDependentNodes *cuGraphNodeGetDependentNodes_oro = nullptr;
tcuGraphNodeGetDependentNodes_v2 *cuGraphNodeGetDependentNodes_v2_oro = nullptr;
...
tcuGraphRemoveDependencies_v2 *cuGraphRemoveDependencies_v2_oro = nullptr;
...
tcuGreenCtxCreate *cuGreenCtxCreate_oro = nullptr;
tcuGreenCtxDestroy *cuGreenCtxDestroy_oro = nullptr;
tcuGreenCtxGetDevResource *cuGreenCtxGetDevResource_oro = nullptr;
tcuGreenCtxRecordEvent *cuGreenCtxRecordEvent_oro = nullptr;
tcuGreenCtxStreamCreate *cuGreenCtxStreamCreate_oro = nullptr;
tcuGreenCtxWaitEvent *cuGreenCtxWaitEvent_oro = nullptr;
...
tcuKernelGetLibrary *cuKernelGetLibrary_oro = nullptr;
tcuKernelGetName *cuKernelGetName_oro = nullptr;
tcuKernelGetParamInfo *cuKernelGetParamInfo_oro = nullptr;
...
tcuLibraryEnumerateKernels *cuLibraryEnumerateKernels_oro = nullptr;
tcuLibraryGetGlobal *cuLibraryGetGlobal_oro = nullptr;
tcuLibraryGetKernel *cuLibraryGetKernel_oro = nullptr;
tcuLibraryGetKernelCount *cuLibraryGetKernelCount_oro = nullptr;
...
tcuLogsCurrent *cuLogsCurrent_oro = nullptr;
tcuLogsDumpToFile *cuLogsDumpToFile_oro = nullptr;
tcuLogsDumpToMemory *cuLogsDumpToMemory_oro = nullptr;
tcuLogsRegisterCallback *cuLogsRegisterCallback_oro = nullptr;
tcuLogsUnregisterCallback *cuLogsUnregisterCallback_oro = nullptr;
...
tcuMemBatchDecompressAsync *cuMemBatchDecompressAsync_oro = nullptr;
...
tcuMemcpy3DBatchAsync *cuMemcpy3DBatchAsync_oro = nullptr;
...
tcuMemcpyBatchAsync *cuMemcpyBatchAsync_oro = nullptr;
...
tcuModuleEnumerateFunctions *cuModuleEnumerateFunctions_oro = nullptr;
tcuModuleGetFunction *cuModuleGetFunction_oro = nullptr;
tcuModuleGetFunctionCount *cuModuleGetFunctionCount_oro = nullptr;
...
tcuStreamBeginCaptureToGraph *cuStreamBeginCaptureToGraph_oro = nullptr;
...
tcuStreamGetCaptureInfo_v3 *cuStreamGetCaptureInfo_v3_oro = nullptr;
tcuStreamGetCtx *cuStreamGetCtx_oro = nullptr;
tcuStreamGetCtx_v2 *cuStreamGetCtx_v2_oro = nullptr;
tcuStreamGetDevice *cuStreamGetDevice_oro = nullptr;
tcuStreamGetFlags *cuStreamGetFlags_oro = nullptr;
tcuStreamGetGreenCtx *cuStreamGetGreenCtx_oro = nullptr;
...
tcuStreamUpdateCaptureDependencies_v2 *cuStreamUpdateCaptureDependencies_v2_oro = nullptr;
...
tcuTensorMapEncodeIm2colWide *cuTensorMapEncodeIm2colWide_oro = nullptr;
...
tcudaDeviceRegisterAsyncNotification *cudaDeviceRegisterAsyncNotification_oro = nullptr;
...
tcudaDeviceUnregisterAsyncNotification *cudaDeviceUnregisterAsyncNotification_oro = nullptr;
...
tcudaEventElapsedTime_v2 *cudaEventElapsedTime_v2_oro = nullptr;
...
tcudaFuncGetName *cudaFuncGetName_oro = nullptr;
tcudaFuncGetParamInfo *cudaFuncGetParamInfo_oro = nullptr;
...
tcudaGetDriverEntryPointByVersion *cudaGetDriverEntryPointByVersion_oro = nullptr;
...
tcudaGraphAddDependencies_v2 *cudaGraphAddDependencies_v2_oro = nullptr;
...
tcudaGraphAddNode_v2 *cudaGraphAddNode_v2_oro = nullptr;
tcudaGraphChildGraphNodeGetGraph *cudaGraphChildGraphNodeGetGraph_oro = nullptr;
tcudaGraphClone *cudaGraphClone_oro = nullptr;
tcudaGraphConditionalHandleCreate *cudaGraphConditionalHandleCreate_oro = nullptr;
...
tcudaGraphGetEdges_v2 *cudaGraphGetEdges_v2_oro = nullptr;
...
tcudaGraphNodeGetDependencies_v2 *cudaGraphNodeGetDependencies_v2_oro = nullptr;
tcudaGraphNodeGetDependentNodes *cudaGraphNodeGetDependentNodes_oro = nullptr;
tcudaGraphNodeGetDependentNodes_v2 *cudaGraphNodeGetDependentNodes_v2_oro = nullptr;
...
tcudaGraphRemoveDependencies_v2 *cudaGraphRemoveDependencies_v2_oro = nullptr;
...
tcudaKernelSetAttributeForDevice *cudaKernelSetAttributeForDevice_oro = nullptr;
...
tcudaLibraryEnumerateKernels *cudaLibraryEnumerateKernels_oro = nullptr;
tcudaLibraryGetGlobal *cudaLibraryGetGlobal_oro = nullptr;
tcudaLibraryGetKernel *cudaLibraryGetKernel_oro = nullptr;
tcudaLibraryGetKernelCount *cudaLibraryGetKernelCount_oro = nullptr;
tcudaLibraryGetManaged *cudaLibraryGetManaged_oro = nullptr;
tcudaLibraryGetUnifiedFunction *cudaLibraryGetUnifiedFunction_oro = nullptr;
tcudaLibraryLoadData *cudaLibraryLoadData_oro = nullptr;
tcudaLibraryLoadFromFile *cudaLibraryLoadFromFile_oro = nullptr;
tcudaLibraryUnload *cudaLibraryUnload_oro = nullptr;
...
tcudaMemcpy3DBatchAsync *cudaMemcpy3DBatchAsync_oro = nullptr;
...
tcudaMemcpyBatchAsync *cudaMemcpyBatchAsync_oro = nullptr;
...
tcudaStreamBeginCaptureToGraph *cudaStreamBeginCaptureToGraph_oro = nullptr;
...
tcudaStreamGetCaptureInfo_v3 *cudaStreamGetCaptureInfo_v3_oro = nullptr;
tcudaStreamGetDevice *cudaStreamGetDevice_oro = nullptr;
...
tcudaStreamUpdateCaptureDependencies_v2 *cudaStreamUpdateCaptureDependencies_v2_oro = nullptr;
...
tnvrtcGetPCHCreateStatus *nvrtcGetPCHCreateStatus_oro = nullptr;
tnvrtcGetPCHHeapSize *nvrtcGetPCHHeapSize_oro = nullptr;
tnvrtcGetPCHHeapSizeRequired *nvrtcGetPCHHeapSizeRequired_oro = nullptr;
...
tnvrtcSetFlowCallback *nvrtcSetFlowCallback_oro = nullptr;
tnvrtcSetPCHHeapSize *nvrtcSetPCHHeapSize_oro = nullptr;
...
_LIBRARY_FIND( cuda_lib, cuCoredumpGetAttribute );
_LIBRARY_FIND( cuda_lib, cuCoredumpGetAttributeGlobal );
_LIBRARY_FIND( cuda_lib, cuCoredumpSetAttribute );
_LIBRARY_FIND( cuda_lib, cuCoredumpSetAttributeGlobal );
_LIBRARY_FIND( cuda_lib, cuCtxAttach );
_LIBRARY_FIND( cuda_lib, cuCtxCreate_v2 );
_LIBRARY_FIND( cuda_lib, cuCtxCreate_v3 );
_LIBRARY_FIND( cuda_lib, cuCtxCreate_v4 );
...
_LIBRARY_FIND( cuda_lib, cuCtxFromGreenCtx );
...
_LIBRARY_FIND( cuda_lib, cuCtxGetDevResource );
...
_LIBRARY_FIND( cuda_lib, cuCtxRecordEvent );
...
_LIBRARY_FIND( cuda_lib, cuCtxSetFlags );
...
_LIBRARY_FIND( cuda_lib, cuCtxWaitEvent );
_LIBRARY_FIND( cuda_lib, cuDestroyExternalMemory );
_LIBRARY_FIND( cuda_lib, cuDestroyExternalSemaphore );
_LIBRARY_FIND( cuda_lib, cuDevResourceGenerateDesc );
_LIBRARY_FIND( cuda_lib, cuDevSmResourceSplitByCount );
...
_LIBRARY_FIND( cuda_lib, cuDeviceGetDevResource );
...
_LIBRARY_FIND( cuda_lib, cuDeviceRegisterAsyncNotification );
...
_LIBRARY_FIND( cuda_lib, cuDeviceUnregisterAsyncNotification );
_LIBRARY_FIND( cuda_lib, cuDriverGetVersion );
...
_LIBRARY_FIND( cuda_lib, cuFuncGetName );
_LIBRARY_FIND( cuda_lib, cuFuncGetParamInfo );
_LIBRARY_FIND( cuda_lib, cuFuncIsLoaded );
_LIBRARY_FIND( cuda_lib, cuFuncLoad );
...
_LIBRARY_FIND( cuda_lib, cuGraphAddDependencies_v2 );
...
_LIBRARY_FIND( cuda_lib, cuGraphAddNode );
_LIBRARY_FIND( cuda_lib, cuGraphAddNode_v2 );
...
_LIBRARY_FIND( cuda_lib, cuGraphConditionalHandleCreate );
...
_LIBRARY_FIND( cuda_lib, cuGraphExecNodeSetParams );
...
_LIBRARY_FIND( cuda_lib, cuGraphGetEdges_v2 );
...
_LIBRARY_FIND( cuda_lib, cuGraphNodeGetDependencies_v2 );
_LIBRARY_FIND( cuda_lib, cuGraphNodeGetDependentNodes );
_LIBRARY_FIND( cuda_lib, cuGraphNodeGetDependentNodes_v2 );
...
_LIBRARY_FIND( cuda_lib, cuGreenCtxCreate );
_LIBRARY_FIND( cuda_lib, cuGreenCtxDestroy );
_LIBRARY_FIND( cuda_lib, cuGreenCtxGetDevResource );
_LIBRARY_FIND( cuda_lib, cuGreenCtxRecordEvent );
_LIBRARY_FIND( cuda_lib, cuGreenCtxStreamCreate );
_LIBRARY_FIND( cuda_lib, cuGreenCtxWaitEvent );
...
_LIBRARY_FIND( cuda_lib, cuKernelGetLibrary );
_LIBRARY_FIND( cuda_lib, cuKernelGetName );
_LIBRARY_FIND( cuda_lib, cuKernelGetParamInfo );
...
_LIBRARY_FIND( cuda_lib, cuLibraryEnumerateKernels );
_LIBRARY_FIND( cuda_lib, cuLibraryGetGlobal );
_LIBRARY_FIND( cuda_lib, cuLibraryGetKernel );
_LIBRARY_FIND( cuda_lib, cuLibraryGetKernelCount );
...
_LIBRARY_FIND( cuda_lib, cuMemAdvise_v2 );
...
_LIBRARY_FIND( cuda_lib, cuMemBatchDecompressAsync );
...
_LIBRARY_FIND( cuda_lib, cuMemPrefetchAsync_v2 );
...
_LIBRARY_FIND( cuda_lib, cuModuleEnumerateFunctions );
_LIBRARY_FIND( cuda_lib, cuModuleGetFunction );
_LIBRARY_FIND( cuda_lib, cuModuleGetFunctionCount );
...
_LIBRARY_FIND( cuda_lib, cuMulticastAddDevice );
_LIBRARY_FIND( cuda_lib, cuMulticastBindAddr );
_LIBRARY_FIND( cuda_lib, cuMulticastBindMem );
_LIBRARY_FIND( cuda_lib, cuMulticastCreate );
_LIBRARY_FIND( cuda_lib, cuMulticastGetGranularity );
_LIBRARY_FIND( cuda_lib, cuMulticastUnbind );
...
_LIBRARY_FIND( cuda_lib, cuStreamBeginCaptureToGraph );
...
_LIBRARY_FIND( cuda_lib, cuStreamGetCaptureInfo_v3 );
_LIBRARY_FIND( cuda_lib, cuStreamGetCtx );
_LIBRARY_FIND( cuda_lib, cuStreamGetCtx_v2 );
_LIBRARY_FIND( cuda_lib, cuStreamGetFlags );
_LIBRARY_FIND( cuda_lib, cuStreamGetGreenCtx );
...
_LIBRARY_FIND( cuda_lib, cuStreamUpdateCaptureDependencies_v2 );
...
_LIBRARY_FIND( cudart_lib, cudaDeviceRegisterAsyncNotification );
...
_LIBRARY_FIND( cudart_lib, cudaDeviceUnregisterAsyncNotification );
...
_LIBRARY_FIND( cudart_lib, cudaEventElapsedTime_v2 );
...
_LIBRARY_FIND( cudart_lib, cudaFuncGetName );
_LIBRARY_FIND( cudart_lib, cudaFuncGetParamInfo );
...
_LIBRARY_FIND( cudart_lib, cudaGetDriverEntryPointByVersion );
...
_LIBRARY_FIND( cudart_lib, cudaGraphAddDependencies_v2 );
...
_LIBRARY_FIND( cudart_lib, cudaGraphAddNode_v2 );
_LIBRARY_FIND( cudart_lib, cudaGraphChildGraphNodeGetGraph );
_LIBRARY_FIND( cudart_lib, cudaGraphClone );
_LIBRARY_FIND( cudart_lib, cudaGraphConditionalHandleCreate );
...
_LIBRARY_FIND( cudart_lib, cudaGraphGetEdges_v2 );
...
_LIBRARY_FIND( cudart_lib, cudaGraphNodeGetDependencies_v2 );
_LIBRARY_FIND( cudart_lib, cudaGraphNodeGetDependentNodes );
_LIBRARY_FIND( cudart_lib, cudaGraphNodeGetDependentNodes_v2 );
...
_LIBRARY_FIND( cudart_lib, cudaGraphRemoveDependencies_v2 );
...
_LIBRARY_FIND( cudart_lib, cudaKernelSetAttributeForDevice );
...
_LIBRARY_FIND( cudart_lib, cudaLibraryEnumerateKernels );
_LIBRARY_FIND( cudart_lib, cudaLibraryGetGlobal );
_LIBRARY_FIND( cudart_lib, cudaLibraryGetKernel );
_LIBRARY_FIND( cudart_lib, cudaLibraryGetKernelCount );
_LIBRARY_FIND( cudart_lib, cudaLibraryGetManaged );
_LIBRARY_FIND( cudart_lib, cudaLibraryGetUnifiedFunction );
_LIBRARY_FIND( cudart_lib, cudaLibraryLoadData );
_LIBRARY_FIND( cudart_lib, cudaLibraryLoadFromFile );
_LIBRARY_FIND( cudart_lib, cudaLibraryUnload );
...
_LIBRARY_FIND( cudart_lib, cudaMemcpy3DBatchAsync );
...
_LIBRARY_FIND( cudart_lib, cudaMemcpyBatchAsync );
...
_LIBRARY_FIND( cudart_lib, cudaStreamBeginCaptureToGraph );
...
_LIBRARY_FIND( cudart_lib, cudaStreamGetCaptureInfo_v3 );
_LIBRARY_FIND( cudart_lib, cudaStreamGetDevice );
...
_LIBRARY_FIND( cudart_lib, cudaStreamUpdateCaptureDependencies_v2 );
...
_LIBRARY_FIND( nvrtc_lib, nvrtcGetPCHCreateStatus );
_LIBRARY_FIND( nvrtc_lib, nvrtcGetPCHHeapSize );
_LIBRARY_FIND( nvrtc_lib, nvrtcGetPCHHeapSizeRequired );
...
_LIBRARY_FIND( nvrtc_lib, nvrtcSetFlowCallback );
_LIBRARY_FIND( nvrtc_lib, nvrtcSetPCHHeapSize );
