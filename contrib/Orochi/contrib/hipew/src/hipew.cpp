...
thipDeviceGetTexture1DLinearMaxWidth *hipDeviceGetTexture1DLinearMaxWidth = nullptr;
...
thipDrvGraphAddMemFreeNode *hipDrvGraphAddMemFreeNode = nullptr;
thipDrvGraphAddMemcpyNode *hipDrvGraphAddMemcpyNode = nullptr;
thipDrvGraphAddMemsetNode *hipDrvGraphAddMemsetNode = nullptr;
thipDrvGraphExecMemcpyNodeSetParams *hipDrvGraphExecMemcpyNodeSetParams = nullptr;
thipDrvGraphExecMemsetNodeSetParams *hipDrvGraphExecMemsetNodeSetParams = nullptr;
thipDrvGraphMemcpyNodeGetParams *hipDrvGraphMemcpyNodeGetParams = nullptr;
thipDrvGraphMemcpyNodeSetParams *hipDrvGraphMemcpyNodeSetParams = nullptr;
...
thipEventRecordWithFlags *hipEventRecordWithFlags = nullptr;
...
thipGraphAddBatchMemOpNode *hipGraphAddBatchMemOpNode = nullptr;
...
thipGraphAddNode *hipGraphAddNode = nullptr;
thipGraphBatchMemOpNodeGetParams *hipGraphBatchMemOpNodeGetParams = nullptr;
thipGraphBatchMemOpNodeSetParams *hipGraphBatchMemOpNodeSetParams = nullptr;
...
thipGraphExecBatchMemOpNodeSetParams *hipGraphExecBatchMemOpNodeSetParams = nullptr;
...
thipGraphExecGetFlags *hipGraphExecGetFlags = nullptr;
...
thipGraphExecNodeSetParams *hipGraphExecNodeSetParams = nullptr;
...
thipGraphInstantiateWithParams *hipGraphInstantiateWithParams = nullptr;
...
thipGraphNodeSetParams *hipGraphNodeSetParams = nullptr;
...
thipMemcpy2DArrayToArray *hipMemcpy2DArrayToArray = nullptr;
...
thipMemcpyAtoA *hipMemcpyAtoA = nullptr;
thipMemcpyAtoD *hipMemcpyAtoD = nullptr;
thipMemcpyAtoH *hipMemcpyAtoH = nullptr;
thipMemcpyAtoHAsync *hipMemcpyAtoHAsync = nullptr;
thipMemcpyDtoA *hipMemcpyDtoA = nullptr;
...
thipMemcpyHtoAAsync *hipMemcpyHtoAAsync = nullptr;
...
thipSetValidDevices *hipSetValidDevices = nullptr;
...
thipStreamBatchMemOp *hipStreamBatchMemOp = nullptr;
thipStreamBeginCapture *hipStreamBeginCapture = nullptr;
thipStreamBeginCaptureToGraph *hipStreamBeginCaptureToGraph = nullptr;
...
thipTexRefGetArray *hipTexRefGetArray = nullptr;
thipTexRefGetBorderColor *hipTexRefGetBorderColor = nullptr;
...
_LIBRARY_FIND( hip_lib, hipDeviceGetTexture1DLinearMaxWidth );
...
_LIBRARY_FIND( hip_lib, hipDrvGraphAddMemFreeNode );
_LIBRARY_FIND( hip_lib, hipDrvGraphAddMemcpyNode );
_LIBRARY_FIND( hip_lib, hipDrvGraphAddMemsetNode );
_LIBRARY_FIND( hip_lib, hipDrvGraphExecMemcpyNodeSetParams );
_LIBRARY_FIND( hip_lib, hipDrvGraphExecMemsetNodeSetParams );
_LIBRARY_FIND( hip_lib, hipDrvGraphMemcpyNodeGetParams );
_LIBRARY_FIND( hip_lib, hipDrvGraphMemcpyNodeSetParams );
...
_LIBRARY_FIND( hip_lib, hipGraphAddBatchMemOpNode );
...
_LIBRARY_FIND( hip_lib, hipGraphAddExternalSemaphoresSignalNode );
_LIBRARY_FIND( hip_lib, hipGraphAddExternalSemaphoresWaitNode );
...
_LIBRARY_FIND( hip_lib, hipGraphAddNode );
_LIBRARY_FIND( hip_lib, hipGraphBatchMemOpNodeGetParams );
_LIBRARY_FIND( hip_lib, hipGraphBatchMemOpNodeSetParams );
...
_LIBRARY_FIND( hip_lib, hipGraphExecBatchMemOpNodeSetParams );
...
_LIBRARY_FIND( hip_lib, hipGraphExecExternalSemaphoresSignalNodeSetParams );
_LIBRARY_FIND( hip_lib, hipGraphExecExternalSemaphoresWaitNodeSetParams );
_LIBRARY_FIND( hip_lib, hipGraphExecGetFlags );
...
_LIBRARY_FIND( hip_lib, hipGraphExecNodeSetParams );
_LIBRARY_FIND( hip_lib, hipGraphExecUpdate );
_LIBRARY_FIND( hip_lib, hipGraphExternalSemaphoresSignalNodeGetParams );
_LIBRARY_FIND( hip_lib, hipGraphExternalSemaphoresSignalNodeSetParams );
_LIBRARY_FIND( hip_lib, hipGraphExternalSemaphoresWaitNodeGetParams );
_LIBRARY_FIND( hip_lib, hipGraphExternalSemaphoresWaitNodeSetParams );
...
_LIBRARY_FIND( hip_lib, hipGraphInstantiateWithParams );
...
_LIBRARY_FIND( hip_lib, hipGraphNodeSetParams );
...
_LIBRARY_FIND( hip_lib, hipMemcpy2DArrayToArray );
...
_LIBRARY_FIND( hip_lib, hipMemcpyAtoA );
_LIBRARY_FIND( hip_lib, hipMemcpyAtoD );
_LIBRARY_FIND( hip_lib, hipMemcpyAtoH );
_LIBRARY_FIND( hip_lib, hipMemcpyAtoHAsync );
_LIBRARY_FIND( hip_lib, hipMemcpyDtoA );
...
_LIBRARY_FIND( hip_lib, hipMemcpyHtoAAsync );
...
_LIBRARY_FIND( hip_lib, hipSetValidDevices );
...
_LIBRARY_FIND( hip_lib, hipStreamBatchMemOp );
_LIBRARY_FIND( hip_lib, hipStreamBeginCapture );
_LIBRARY_FIND( hip_lib, hipStreamBeginCaptureToGraph );
...
_LIBRARY_FIND( hip_lib, hipTexRefGetArray );
_LIBRARY_FIND( hip_lib, hipTexRefGetBorderColor );
...
_LIBRARY_FIND( hip_lib, hipTexRefGetMipMappedArray );
