...
namespace NxlHash
{
  ...
  void hash(worker &worker, byte *in, int len, byte *out)
  {
    ...
    // skein(scratchData, scratchData);
    skein_hash(256, scratchData, 256, scratchData);    
  ...
  int test() {
    ...
    const char* expected = "b0973147902d06c16845c1438cd6effcd0220d11609e24af0f44b56e7417c093";
  ...
  // int test() {
    ...
    // alignas(64) NxlHash::worker *w = (NxlHash::worker *)malloc_huge_pages(sizeof(NxlHash::worker));
