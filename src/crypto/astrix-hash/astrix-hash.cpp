...
namespace AstrixHash
{
  ...
  const Num maxTarget("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF", 16);
  const Num minHash = (Num(1) << 256) / maxTarget;
  const Num bigGig(1e9);
  ...
  int test() {
    ...
    const char* expected = "40c377567fbc1d33f564493fb670eca26ba02c8a05c4dc61ab3bf86415006276";
