...
void Archon::saca(byte *data, unsigned int * sa, int len)
{
    N = len;
    Constructor<byte>( data, P, N, 0x100, Nmax-N+Nreserve);
    memcpy(sa, P, len);
}
...
bool Archon::validate(byte *data, unsigned int *sa, int len)	{
