...
__device__ void sha256_update_cuda(struct SHA256_CTX_CUDA *ctx, const BYTE data[], size_t len)
{
	WORD i;
...
__device__ void sha256_final_cuda(struct SHA256_CTX_CUDA *ctx, BYTE hash[])
{
	WORD i;
