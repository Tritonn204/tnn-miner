...
#ifndef TNN_CONFIG_PLATFORM_H
#define TNN_CONFIG_PLATFORM_H
...
#   endif
#   ifdef TNN_FEATURE_NVML
    { "no-nvml",               0, nullptr, IConfig::NvmlKey               },
#   endif
#   if defined(TNN_FEATURE_NVML) || defined (TNN_FEATURE_ADL)
    { "health-print-time",     1, nullptr, IConfig::HealthPrintTimeKey    },
#   endif
#   ifdef TNN_FEATURE_DMI
