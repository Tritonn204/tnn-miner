...
#include "cshake.hip.h"


#ifndef HIP_ALLOCA_LIMIT
# define HIP_ALLOCA_LIMIT (16UL << 10)
#endif


#include <sys/stat.h>
#if HIP_ALLOCA_LIMIT > 0
# if defined(__GLIBC__) || defined(__sun) || defined(__CYGWIN__) || defined(__APPLE__)
#  include <alloca.h>
# elif defined(_WIN32)
#  include <malloc.h>
#  if !defined(alloca)
#   define hip_alloca _hip_alloca  /* For clang with MS Codegen */
#  endif
# endif
#endif
#include <errno.h>
...
__device__ static void *(*volatile my_explicit_memset)(void *, int, size_t) = memset;
