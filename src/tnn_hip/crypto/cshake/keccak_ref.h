 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__leaf__, __nonnull__)))
int libkeccak_state_copy(struct libkeccak_state *, const struct libkeccak_state *);
...
size_t libkeccak_state_marshal(const struct libkeccak_state *, void *);
...
size_t libkeccak_state_unmarshal(struct libkeccak_state *, const void *);
...
void libkeccak_cshake_initialise(struct libkeccak_state *,
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__, __nothrow__)))
void libkeccak_zerocopy_update(struct libkeccak_state *, const void *, size_t);
...
int libkeccak_fast_update(struct libkeccak_state *, const void *, size_t);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__)))
int libkeccak_update(struct libkeccak_state *, const void *, size_t);
...
void libkeccak_zerocopy_digest(struct libkeccak_state *, void *, size_t,
...
int libkeccak_fast_digest(struct libkeccak_state *, const void *, size_t,
                          size_t, const char *, void *);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(1))))
int libkeccak_digest(struct libkeccak_state *, const void *, size_t,
                     size_t, const char *, void *);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__, __nothrow__)))
void libkeccak_simple_squeeze(struct libkeccak_state *, long int);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__, __nothrow__)))
void libkeccak_fast_squeeze(struct libkeccak_state *, long int);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__, __nothrow__)))
void libkeccak_squeeze(struct libkeccak_state *, void *);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__leaf__, __nonnull__, __nothrow__)))
void libkeccak_behex_upper(char *, const void *, size_t);
...
int libkeccak_generalised_sum_fd(int, struct libkeccak_state *, const struct libkeccak_spec *,
                                 const char *, void *);
...
inline int
libkeccak_keccaksum_fd(int fd, struct libkeccak_state *state,
                       const struct libkeccak_spec *spec, void *hashsum)
{
...
inline int
libkeccak_sha3sum_fd(int fd, struct libkeccak_state *state, long output, void *hashsum)
{
...
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(2), __artificial__)))
inline int
libkeccak_rawshakesum_fd(int fd, struct libkeccak_state *state, long semicapacity, long output, void *hashsum)
{
	struct libkeccak_spec spec;
...
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(2), __artificial__)))
inline int
libkeccak_shakesum_fd(int fd, struct libkeccak_state *state, long semicapacity, long output, void *hashsum)
{
	struct libkeccak_spec spec;
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(1))))
int libkeccak_hmac_set_key(struct libkeccak_hmac_state *, const void *, size_t);
...
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__)))
inline int
libkeccak_hmac_initialise(struct libkeccak_hmac_state *state, const struct libkeccak_spec *spec,
...
libkeccak_hmac_create(const struct libkeccak_spec *spec, const void *key, size_t key_length)
{
	struct libkeccak_hmac_state *state = (libkeccak_hmac_state*)malloc(sizeof(struct libkeccak_hmac_state));
...
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(1))))
inline int
libkeccak_hmac_reset(struct libkeccak_hmac_state *state, const void *key, size_t key_length)
{
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__)))
int libkeccak_hmac_copy(struct libkeccak_hmac_state *, const struct libkeccak_hmac_state *);
...
{
	struct libkeccak_hmac_state *dest = (libkeccak_hmac_state*)malloc(sizeof(struct libkeccak_hmac_state));
...
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(1), __nothrow__)))
inline size_t
libkeccak_hmac_marshal(const struct libkeccak_hmac_state *state, uint8_t *data_)
{
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(2))))
size_t libkeccak_hmac_unmarshal(struct libkeccak_hmac_state *, const void *);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(1))))
int libkeccak_hmac_fast_update(struct libkeccak_hmac_state *state, const void *msg, size_t msglen);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(1))))
int libkeccak_hmac_update(struct libkeccak_hmac_state *state, const void *msg, size_t msglen);
 ...
 */
LIBKECCAK_GCC_ONLY(__attribute__((__nonnull__(1))))
int libkeccak_hmac_digest(struct libkeccak_hmac_state *state, const void *msg, size_t msglen,
                          size_t bits, const char *suffix, void *hashsum);
