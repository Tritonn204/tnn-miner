if (WITH_DMI AND (TNN_OS_WIN OR TNN_OS_LINUX OR TNN_OS_FREEBSD OR (TNN_OS_MACOS AND NOT TNN_ARM)))
    set(WITH_DMI ON)
else()
    set(WITH_DMI OFF)
endif()
