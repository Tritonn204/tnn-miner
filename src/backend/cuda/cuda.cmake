if (BUILD_STATIC AND TNN_OS_UNIX AND WITH_CUDA)
...
if (WITH_CUDA)
    add_definitions(/DTNN_FEATURE_CUDA)
   ...
   if (WITH_NVML AND NOT APPLE)
       add_definitions(/DTNN_FEATURE_NVML)
       ...
       remove_definitions(/DTNN_FEATURE_NVML)
   endif()
   ...
   if (WITH_KAWPOW)
    ...
    remove_definitions(/DTNN_FEATURE_CUDA)
    remove_definitions(/DTNN_FEATURE_NVML)
