if (BUILD_STATIC AND TNN_OS_UNIX AND WITH_OPENCL)
...
if (WITH_OPENCL)
    add_definitions(/DTNN_FEATURE_OPENCL)
    ...
    if (WITH_STRICT_CACHE)
        add_definitions(/DTNN_STRICT_OPENCL_CACHE)
    else()
        remove_definitions(/DTNN_STRICT_OPENCL_CACHE)
    endif()

    if (WITH_INTERLEAVE_DEBUG_LOG)
        add_definitions(/DTNN_INTERLEAVE_DEBUG)
    endif()

    if (WITH_ADL AND (TNN_OS_WIN OR TNN_OS_LINUX))
        add_definitions(/DTNN_FEATURE_ADL)
       ...
       remove_definitions(/DTNN_FEATURE_ADL)
    endif()
else()
    remove_definitions(/DTNN_FEATURE_OPENCL)
    remove_definitions(/DTNN_FEATURE_ADL)
